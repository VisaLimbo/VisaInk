...
The following post analyses visa wait times for 237 embassies across 172 countries. There results are shown for three categories, Visitor Visa, Student/Exchange Visitor Visas and All Other Non-immigrant visa. 

<!-- * the average delay for -->
<!--   + Visitor Visas: 237 days  -->
<!--   + Student Exchange: 46 days and,  -->
<!--   + All Other Non-immigrant: 68 days -->



Based on State Department [data](https://travel.state.gov/content/travel/en/us-visas/visa-information-resources/wait-times.html), delay for Visitor visas is the highest, based on July, 2022 average delay is around 237 days. Following embassies currently have visitor's visa wait time for over 1 year
...
Based on State Department [data](https://travel.state.gov/content/travel/en/us-visas/visa-information-resources/wait-times.html), average delay for Student/Exchange Visitor Visas is 46 days, following are the embassies with maximum lags
...
Based on State Department [data](https://travel.state.gov/content/travel/en/us-visas/visa-information-resources/wait-times.html), average delay for All Other Non-immigrant Visas is 68 days, following are countries with longest delays
```{r, echo=FALSE, warning=FALSE, message=F}
# Scraped Data Stats
# --------------
