...
### Lag in visiting visa exceeds more than 2 years!
...
ggplot(scpdt_cty[scpdt_cty$VisitorVisa>365,], aes(y=reorder(Country,VisitorVisa), x=VisitorVisa)) +
  ...
  xlab('Waitime by country in days (avg across Embassies)')

```

## The delay is consistent across all visa categories
